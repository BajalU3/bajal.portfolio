  ...
  return (
    <section className="py-32 px-4 md:px-12 lg:px-24">
      <div className="max-w-5xl mx-auto">
        <h2 className="text-sm uppercase tracking-[0.3em] text-primary mb-16 text-center">Core Arsenal</h2>
        
        <div className="space-y-24">
          {skills.map((skillGroup, idx) => (
            <div key={idx} className="flex flex-col items-center">
              <h3 className="text-2xl font-light text-white mb-10 tracking-wide text-center">
                {skillGroup.category}
              </h3>
              <div className="flex flex-wrap justify-center gap-4 max-w-4xl">
                {skillGroup.items.map((skill, i) => (
                  <motion.div
                    ...
                    className="glass px-6 py-3 rounded-full text-gray-300 font-medium tracking-wide border border-white/5 cursor-default relative overflow-hidden group"
                  >
